...
================================================== -->
	<div class="container">
		...
		<div class="two_third lastcolumn contact1">
			<div id="contactForm">
				<h2>Report Incidence</h2>
				<div class="sepContainer"></div>
				<form:form method="post" modelAttribute="incidence">
				  	<div class="name">
						<label for="name">Report the Incident :</label>
						<p>Please enter your full name</p>
						<form:input type="text" path="reportedMessage"  />
					</div>
					<div class="name">
						<label for="fathersname">No of people Affected:</label>
						<form:input type="text" path="noPeople" />
					</div>
					<div class="name">
						<label for="mothersname">Help Needed:</label>
						<form:input type="text" path="helpNeeded"
